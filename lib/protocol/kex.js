...
const createKeyExchange = (() => {
  ...
  const getDHParamFunc = (minBits, prefBits, maxBits) => {
    //returns either an array containing the secure prime (see `crypto.createDiffieHellman`) as a `Buffer` (array index 0)
    // Creating DiffieHellman 
    console.log("Creating Diffie Hellman...")
      ...
      switch (this._step) {
        case 1:
          ...
          */
          ...
          this._protocol._getDHParams = getDHParamFunc;
